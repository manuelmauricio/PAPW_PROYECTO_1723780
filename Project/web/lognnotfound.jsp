<%-- 
    Document   : lognnotfound
    Created on : 19/11/2019, 01:41:47 PM
    Author     : Mauricio
--%>
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5" style="background-color : white;">
          <div class="card-body">
            <font size ="5">Usuario y/o contraseña incorrectos</font>
            <br>
            <font size ="4">Porfavor intentelo de nuevo o cree una cuenta nueva</font>
            <br>
            <form class="form-signin" method="POST" action="Inicio" enctype="multipart/form-data">
              <div class="form-label-group">
			  <label for="inputName">Usuario</label>
                <input type="text"  class="form-control" name="nameUserx" placeholder="usuario" required autofocus>
              ...
              <div class="form-label-group">
			   <label for="inputName">Contraseña</label>
                <input type="password" class="form-control" name="nameUserxx" placeholder="********" required>
			<small id="PasswordHelp" class="form-text text-muted">*ingrese su contraseña</small>
			  ...
			  <a href="registro.jsp">Crear cuenta</a>
			   ...
			   <div class="d-flex justify-content-center">
			  <a href="login.jsp">Vover a incio de sesión</a>
			    </div>
                >
                             <br>
                           
                          <div class="d-flex justify-content-center">
			  <a href="loginadmin.jsp">Ingresar como administrador</a>
			    </div>
                           <br>
