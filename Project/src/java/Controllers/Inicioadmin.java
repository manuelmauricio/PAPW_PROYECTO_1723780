...
@WebServlet(name = "Inicioadmin", urlPatterns = {"/Inicioadmin"})
   ...
   /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      PrintWriter out = response.getWriter();
              ...
              try{
        String name = request.getParameter("nameUserxz");
         String namel = request.getParameter("nameUserxxz");
